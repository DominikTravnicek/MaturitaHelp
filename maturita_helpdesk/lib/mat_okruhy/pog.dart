...
class PogScreen extends StatefulWidget {
  const PogScreen({Key? key}) : super(key: key);

  @override
  State<PogScreen> createState() => _PogScreenState();
}

bool _isLoading = true;

class _PogScreenState extends State<PogScreen> {
  @override
  void initState() {
