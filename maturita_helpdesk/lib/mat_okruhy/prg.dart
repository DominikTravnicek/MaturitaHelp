...
class PrgScreen extends StatefulWidget {
  const PrgScreen({Key? key}) : super(key: key);

  @override
  State<PrgScreen> createState() => _PrgScreenState();
}

bool _isLoading = true;

class _PrgScreenState extends State<PrgScreen> {
  @override
  void initState() {
